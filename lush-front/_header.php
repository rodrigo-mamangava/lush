...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap -->
        <link href="fullscreen-menu/css/font-awesome.min.css" rel="stylesheet">

        <!--<link href="fullscreen-menu/css/menufullpage.css" rel="stylesheet">-->
        <link href="fullmenu-2/dist/jquery.fatNav.min.css" rel="stylesheet">
                ...
                <div class="header-content">
                    <div class="row">
                        ...
                        <div class="col-xs-4 titulo header-item">
                            <h1><img src="img/logo_lush_branco@2x.png"></h1>
                        </div>
                        <div class="col-xs-4 header-item">
                            <ul class="botoes-r">

                                <li><a href="#" class="btn-lupa"><img src="img/lupa@2x.png" class="img-responsive"></a></li>
